...
template<typename EventType>
inline ze::EventSubscriber<EventType>& ze::EventSubscriber<EventType>::operator=(EventSubscriber const& other)
{
...
template<typename EventType>
inline Priority ze::EventSubscriber<EventType>::getPriority() const noexcept
{
   return m_priority;
}
